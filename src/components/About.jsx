...
const About = () => {
  ...
  useEffect(() => {
    ScrollReveal({ reset: false, distance: '400px' }).reveal('.scrollable-section', { duration: 2000, origin: 'bottom', easing: 'ease'})
  }, [])
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <div className="grid gap-8">
            <div className="flex items-center justify-center max-md:flex-col gap-12 scrollable-section">
            ...
            <div className="flex items-center justify-center max-md:flex-col-reverse gap-12 scrollable-section">
              <p className="text-3xl text-[#E8EDDF] font-bold w-1/3 max-md:w-full max-md:text-lg">
